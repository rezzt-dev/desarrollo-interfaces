...
namespace proyectoPersonas.persistence.manages
{
  internal class ManejoPersonas
  {
    ...
    {
      DBBroker dbBroker = DBBroker.obtenerAgente();
      dbBroker.modificar("UPDATE mydb.persona SET nombre = '" + inputPersona.Nombre + "', apellido = '" + inputPersona.Apellido + "', edad = " + inputPersona.Edad + " WHERE idpersona = " + inputPersona.Id + ";");
    }
  }
}
